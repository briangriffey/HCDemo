...
public final class HipchatRegex {
    ...
    public static final Pattern EMOTICON_PATTERN = Pattern.compile("\\([\\p{Alnum}]{1,15}\\)", Pattern.UNICODE_CHARACTER_CLASS);
     ...
     * email addresses
     */
    public static final Pattern MENTION_PATTERN = Pattern.compile("@\\w+", Pattern.UNICODE_CHARACTER_CLASS);
