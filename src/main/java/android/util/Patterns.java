...
//bgriffey - for some reason java doesn't have a good regex for http handy, so I ho
...
public class Patterns {
    ...
    public static final Pattern DOMAIN_NAME
            = Pattern.compile("(" + HOST_NAME + "|" + IP_ADDRESS + "|" + LOCALHOST +")");

    private static final String PROTOCOL = "(?i:http|https|rtsp):\\/\\/";

    private static final String ONLY_HTTP_PROTOCOL = "(?i:http|https):\\/\\/";
    ...
    public static final Pattern WEB_URL_HTTP_REQUIRED = Pattern.compile("("
            + "("
            + "(?:" + ONLY_HTTP_PROTOCOL + "(?:" + USER_INFO + ")?" + ")"
            + "(?:" + DOMAIN_NAME + ")"
            + "(?:" + PORT_NUMBER + ")?"
            + ")"
            + "(" + PATH_AND_QUERY + ")?"
